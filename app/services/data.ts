...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Hijama therapy (cupping) offers key health benefits. Both wet and dry cupping facilities are provided in this setup.",
    image: "/hajjama.jpg",
    imageAlt: "Hijama cups arranged for a traditional cupping treatment",
    introduction: [
      "Hijama therapy, also known as cupping, is offered in a calm, professional setting with careful attention to hygiene, privacy and comfort.",
      "Both wet and dry cupping facilities are provided at our setup.",
    ],
    suitableFor: ["Wet cupping", "Dry cupping", "Adults who have been appropriately screened"],
    benefits: ["Improving blood circulation", "Detoxification", "Reducing stress", "Promoting healing"],
    approach: [
      { title: "Consult", text: "We discuss your goals, health history and whether wet or dry cupping is suitable for you." },
      { title: "Treatment", text: "Cups are applied to the agreed areas while your comfort is monitored throughout." },
      { title: "Aftercare", text: "You receive clear guidance for caring for the treated areas after your session." },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Geriatric (Older Adult) Physiotherapy",
