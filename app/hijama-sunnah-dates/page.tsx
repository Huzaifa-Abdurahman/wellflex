...
export default function HijamaSunnahDatesPage() {
  ...
  return <PageShell><main className="sunnah-dates-page">
    ...
    <section className="sunnah-date-cta"><div><p className="section-label">Plan your visit</p><h2>Confirm your date.</h2></div><Link className="button button-light" href={bookingUrl} target="_blank" rel="noreferrer">Message Flex Well <ArrowIcon /></Link></section>
  </main></PageShell>;
}
