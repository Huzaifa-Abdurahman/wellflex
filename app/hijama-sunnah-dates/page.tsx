...
export const metadata: Metadata = {
  title: "Sunnah Hijama Dates | Flex Well Islamabad",
  description: "Understand commonly preferred lunar dates for Sunnah Hijama and arrange a screened appointment at Flex Well Islamabad.",
};
...
export default function HijamaSunnahDatesPage() {
  ...
  return <PageShell><main className="sunnah-dates-page">
    <section className="sunnah-dates-hero"><p className="section-label">Sunnah Hijama</p><h1>Choosing a Hijama date.</h1><p>Many people prefer the 17th, 19th or 21st days of the Islamic lunar month. Local lunar dates can vary, so confirm the calendar date and appointment availability with our team.</p><Link className="button button-primary" href={bookingUrl} target="_blank" rel="noreferrer">Ask about upcoming dates <ArrowIcon /></Link></section>
    ...
    <section className="sunnah-date-cta"><div><p className="section-label">Plan your visit</p><h2>Confirm the lunar date and your appointment together.</h2></div><Link className="button button-light" href={bookingUrl} target="_blank" rel="noreferrer">Message Flex Well <ArrowIcon /></Link></section>
  </main></PageShell>;
}
