...
export const treatments: Treatment[] = [
  ...
  },
  {
    ...
    overview: [
      ...
      "We assess your movement, strength and daily activities, then create a practical plan using targeted exercise, helpful advice and appropriate hands-on care.",
    ],
    commonSigns: ["Pain around the hip or groin", "Stiffness after sitting or rest", "Discomfort while walking or climbing stairs", "Pain when lying on one side", "Reduced confidence with exercise"],
    goals: ["Ease pain during daily activities", "Improve hip movement and strength", "Restore walking and exercise confidence", "Build a practical self-management plan"],
    plan: [
      { title: "Assess", text: "We explore your symptoms and assess hip movement, strength and function." },
      { title: "Settle symptoms", text: "Early advice and movement help reduce irritation during daily tasks." },
      { title: "Build strength", text: "Targeted exercises improve hip support and mobility at a manageable pace." },
      { title: "Return to activity", text: "Your plan progresses toward comfortable walking, work and exercise." },
    ],
  },
  {
