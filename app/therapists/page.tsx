...
export const metadata: Metadata = {
  ...
  description: "Meet Dr Qadeer and Ayesha, the patient-focused therapy team at Flex Well Physiotherapy and Hijama Center in Islamabad.",
};
  ...
  return <PageShell><main className="therapists-page">
    ...
    <section className="therapist-list" aria-label="Flex Well therapy team">
      {therapists.map((therapist, index) => <article className="therapist-profile" key={therapist.name}>
        <div className={`therapist-portrait therapist-portrait-${index + 1}`} aria-hidden="true">
          <span>{therapist.initials}</span>
          <small>Flex Well</small>
        </div>
