  ...
  return <PageShell><main className="home-physio-page">
    <section className="home-physio-hero">
      <div className="home-physio-hero-copy">
        ...
        <h1>Expert care, brought to your doorstep.</h1>
        <p>Personalised home physiotherapy for people who need rehabilitation, mobility support or guided exercise without the difficulty of travelling to a clinic.</p>
      ...
      <div className="home-physio-hero-image"><Image src="/rehabillation.jfif" alt="Physiotherapist helping a patient with guided rehabilitation" fill priority sizes="(max-width: 800px) 100vw, 52vw" /><span>Care in the comfort of home</span></div>
    </section>

    <section className="home-physio-intro">
      <div><p className="section-label">Who we may support</p><h2>When getting to the clinic is the hardest part.</h2><p>A home visit can make structured rehabilitation more accessible for people whose pain, health, mobility or recovery stage makes travel difficult. Every enquiry is reviewed individually to confirm that home physiotherapy is appropriate.</p></div>
    ...
    <section className="home-visit-value">
      <div className="home-visit-value-heading"><p className="section-label">Care built around real life</p><h2>More than clinic treatment in a different room.</h2></div>
      <div className="home-visit-value-grid">
        <article><span>01</span><h3>Practical assessment</h3><p>We see the movements, spaces and everyday tasks the patient actually needs to manage.</p></article>
        <article><span>02</span><h3>Personal rehabilitation</h3><p>Mobility, strength, balance and exercise are matched to current ability and recovery goals.</p></article>
        <article><span>03</span><h3>Family guidance</h3><p>Where appropriate, family members or caregivers receive clear advice for safe daily support.</p></article>
      </div>
    </section>

    <section className="home-visit-process">
      <div className="home-visit-process-heading"><p className="section-label">How it works</p><h2>A clear process from enquiry to progress.</h2></div>
