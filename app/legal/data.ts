...
export const legalPages: LegalPage[] = [
  {
    ...
    summary: "This policy explains what information Flex Well may receive through this website, why we use it, and the choices available to you.",
    sections: [
      { heading: "1. Who we are", paragraphs: ["Flex Well Physiotherapy & Hijama Center is a clinic located on Street 19, Sector J, DHA Phase II, Islamabad, Pakistan. In this policy, “Flex Well”, “we”, “our” and “us” refer to the clinic and its authorised team."] },
  ...
  },
  {
    ...
    title: "Terms of Use",
    label: "Website terms",
    summary: "These terms set out the conditions for using the Flex Well website and its appointment and information features.",
    sections: [
      ...
      { heading: "6. Third-party services", paragraphs: ["The website links to or embeds third-party services including Google Maps, WhatsApp, Instagram and Facebook. Flex Well does not control their availability, security, content or privacy practices. Your use of those services is governed by their own terms."] },
      { heading: "7. Intellectual property", paragraphs: ["Unless otherwise stated, the Flex Well name, website copy, layout and original design elements are owned by or licensed to Flex Well. You may view and print pages for personal, non-commercial use, but may not republish or commercially exploit them without written permission."] },
      { heading: "8. Responsibility", paragraphs: ["To the extent permitted by applicable law, Flex Well is not responsible for losses caused solely by reliance on general website information, interruptions outside our reasonable control, or third-party platforms. Nothing in these terms excludes responsibility that cannot lawfully be excluded."] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "8. Contact", paragraphs: ["For a non-urgent question about whether a Flex Well service may be appropriate to discuss, contact the clinic on +92 309 7708828. A message cannot replace an assessment."] },
    ],
  },
  {
    slug: "cookie-notice",
    ...
    sections: [
      ...
      { heading: "2. Our current use", paragraphs: ["Flex Well does not currently use first-party advertising cookies or a first-party analytics service on this website. The website may rely on strictly necessary technical processes from its hosting environment to deliver pages securely and reliably."] },
  ...
  },
  {
    ...
    summary: "Flex Well aims to make its website understandable and usable for as many people as reasonably possible.",
    sections: [
